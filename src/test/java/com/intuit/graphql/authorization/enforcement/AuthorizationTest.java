...
public class AuthorizationTest {
  ...
  public void introspectionWithAAA001() {
    ...
    assertTrue(results.contains("{\"kind\":\"OBJECT\",\"name\":\"Author\",\"fields\":[{\"name\":\"firstName\",\"args\":[],\"type\":{\"kind\":\"SCALAR\",\"name\":\"String\"},\"isDeprecated\":false}],\"interfaces\":[]}"));
    assertTrue(results.contains("{\"kind\":\"OBJECT\",\"name\":\"Book\",\"fields\":[{\"name\":\"id\",\"args\":[],\"type\":{\"kind\":\"SCALAR\",\"name\":\"ID\"},\"isDeprecated\":false},{\"name\":\"name\",\"args\":[],\"type\":{\"kind\":\"SCALAR\",\"name\":\"String\"},\"isDeprecated\":false},{\"name\":\"pageCount\",\"args\":[],\"type\":{\"kind\":\"SCALAR\",\"name\":\"Int\"},\"isDeprecated\":false},{\"name\":\"author\",\"args\":[],\"type\":{\"kind\":\"OBJECT\",\"name\":\"Author\"},\"isDeprecated\":false}],\"interfaces\":[]}"));
    assertTrue(results.contains("{\"kind\":\"OBJECT\",\"name\":\"Query\",\"fields\":[{\"name\":\"bookById\",\"args\":[{\"name\":\"id\",\"type\":{\"kind\":\"SCALAR\",\"name\":\"ID\"}}],\"type\":{\"kind\":\"OBJECT\",\"name\":\"Book\"},\"isDeprecated\":false}],\"interfaces\":[]}"));
    assertTrue(results.contains("{\"kind\":\"OBJECT\",\"name\":\"Mutation\",\"fields\":[{\"name\":\"updateBookRecord\",\"args\":[{\"name\":\"input\",\"type\":{\"kind\":\"INPUT_OBJECT\",\"name\":\"BookInput\"}}],\"type\":{\"kind\":\"OBJECT\",\"name\":\"Book\"},\"isDeprecated\":false}],\"interfaces\":[]}"));
    assertTrue(results.contains("{\"kind\":\"INPUT_OBJECT\",\"name\":\"BookID\",\"inputFields\":[{\"name\":\"id\",\"type\":{\"kind\":\"SCALAR\",\"name\":\"ID\"}}]}"));
    assertTrue(results.contains("{\"kind\":\"INPUT_OBJECT\",\"name\":\"BookInput\",\"inputFields\":[{\"name\":\"id\",\"type\":{\"kind\":\"SCALAR\",\"name\":\"ID\"}},{\"name\":\"name\",\"type\":{\"kind\":\"SCALAR\",\"name\":\"String\"}},{\"name\":\"pageCount\",\"type\":{\"kind\":\"SCALAR\",\"name\":\"Int\"}},{\"name\":\"author\",\"type\":{\"kind\":\"INPUT_OBJECT\",\"name\":\"AuthorInput\"}}]}"));
    assertTrue(results.contains("{\"kind\":\"INPUT_OBJECT\",\"name\":\"AuthorInput\",\"inputFields\":[{\"name\":\"id\",\"type\":{\"kind\":\"SCALAR\",\"name\":\"ID\"}},{\"name\":\"firstName\",\"type\":{\"kind\":\"SCALAR\",\"name\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"kind\":\"SCALAR\",\"name\":\"String\"}}]}"));
  }
  ...
  public void introspectionWithoutScope() {
    ...
    String results = types.toString();
    assertTrue(results.contains("{\"kind\":\"OBJECT\",\"name\":\"Author\",\"fields\":[{\"name\":\"id\",\"args\":[],\"type\":{\"kind\":\"SCALAR\",\"name\":\"ID\"},\"isDeprecated\":false},{\"name\":\"firstName\",\"args\":[],\"type\":{\"kind\":\"SCALAR\",\"name\":\"String\"},\"isDeprecated\":false},{\"name\":\"lastName\",\"args\":[],\"type\":{\"kind\":\"SCALAR\",\"name\":\"String\"},\"isDeprecated\":false}],\"interfaces\":[]}"));
